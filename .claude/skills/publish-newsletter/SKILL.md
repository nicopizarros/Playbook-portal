...
| **6** | **Fill the fields and source the images.** `tagsProperty` decides whether the piece lands on a hub — read its boundary rule before setting it. | `references/fields-and-taxonomy.md`, `references/images.md` |
