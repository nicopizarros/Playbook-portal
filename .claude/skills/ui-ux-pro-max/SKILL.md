...
The search script lives inside this skill's own directory, not the project directory. Invoke it by its path relative to the project root — do not assume a different working directory:
