...
## Corpus Check
- 411 files · ~973,190 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3145 nodes · 5176 edges · 258 communities (222 shown, 36 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 99 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fdd59781`
...
## Communities (258 total, 36 thin omitted)
...
Cohesion: 0.13
Nodes (17): HomePage(), metadata, AdSlot(), TopicDirectory(), TOPICS, BrandLink(), Header(), normalizeSource() (+9 more)
...
### Community 5 - "LivePreview.tsx"
Cohesion: 0.12
Nodes (22): isEntryDirty(), toPreviewArticle(), LivePreview(), PreviewFooter(), PreviewHeader(), Props, LazyEmbed(), AboutSection() (+14 more)
...
Cohesion: 0.09
Nodes (34): AdminEstiloPage(), ArticuloPage(), canonicalUrlFor(), generateMetadata(), looksLikeHtml(), paragraphsFrom(), pathFor(), PlainBlock (+26 more)
...
Cohesion: 0.11
Nodes (18): FormValidationContext, FormValidationHandle, FormValidationProvider, Registration, useFormValidationRegistrar(), Validator, isValidUrlValue(), NumberField() (+10 more)
...
Cohesion: 0.11
Nodes (26): articleHref(), groupRiver(), Measure(), metadata, NewsBlock, NoticiasHubPage(), tierFor(), When() (+18 more)
...
Cohesion: 0.15
Nodes (17): FutbolBusinessReviewHubPage(), metadata, boardKey(), LaLanaHubPage(), metadata, VisitBeacon(), HomeSidebar(), EventParams (+9 more)

### Community 17 - "ArrayEditor"
Cohesion: 0.11
...
Cohesion: 0.16
Nodes (18): SetPasswordForm(), dateFmt, dateTimeFmt, Props, TeamTab(), handleInvite(), handleRevoke(), acceptInvitation() (+10 more)
...
Cohesion: 0.18
Nodes (13): Tablero de salidas: empujar conexiones tras publicar, Pre-flight en un bloque, contentRevisions, CASE_OPEN_DAYS, buildRow(), CaseRow, db, DRY_RUN (+5 more)
...
### Community 28 - "Playbook — publicación de negocio del deporte MX/LATAM"
Cohesion: 0.13
...
### Community 29 - "main"
Cohesion: 0.15
Nodes (14): publish-newsletter skill, publish-sourced-article skill, resolveSiteUrl https self-fetch gotcha, Tiny local http.createServer harness, Driving the browser with global Playwright, verify skill — run the site locally in a sandbox, CI/CD y despliegue en Vercel, Claude Code skills del proyecto (+6 more)
...
Cohesion: 0.08
Nodes (41): MIN_SCORE, StillMattersSection(), baseScore(), Boleta, bridgeScore(), daysSince(), decayedScore(), decayPerDayFor() (+33 more)
...
Cohesion: 0.12
Nodes (15): Diferir la validación de env vars más allá del import, Notable Engineering Lessons, TEAM_PROFILES, TeamMember, TeamPageStats, TeamProfile, db, articleReads (+7 more)
...
Cohesion: 0.20
Nodes (11): ArchiveFeatureRow(), ArticleTopics(), TIER_COLUMN, Heading, NewsRow(), TagPillRow(), TIER_COLUMN, Article (+3 more)
...
Cohesion: 0.38
Nodes (7): Definitional antithesis (TFBR thesis move), The Futbol Business Review (ghostwritten for Interticket), The uniformity contract (four products, one masthead), check-voice.mjs is a mirror, not a gate, The hammer line, Negative parallelism: exactly one, at the thesis, The rhythm: 2-3 sentences, 40-80 words, one thing per paragraph

### Community 62 - "schema.ts"
Cohesion: 0.10
Nodes (22): AdminDashboardPage(), dynamic, metadata, Props, ALLOWED_CONTENT_TYPES, adapter, { handlers, auth, signIn, signOut }, Database Schema (nine Drizzle tables) (+14 more)
...
Cohesion: 0.21
Nodes (7): dynamic, SITE_JSON_LD, GoogleAnalytics(), CookiePreferencesLink(), Footer(), SocialIcon(), ScrollReveal()
...
Cohesion: 0.06
Nodes (49): dynamic, generateMetadata(), HubPage(), count(), HubChain(), articleMeta(), HubAccess(), HubCross() (+41 more)

### Community 69 - "admin.ts"
Cohesion: 0.22
Nodes (16): archiveArticle(), createArticle(), gateTags(), reloadArticle(), reloadSiteContent(), renderBodyHtml(), requireEditor(), sameMillisecond() (+8 more)
...
Cohesion: 0.22
Nodes (6): AutorPage(), generateMetadata(), Props, metadata, getArticlesByAuthor(), SITE_URL
...
Cohesion: 0.13
Nodes (19): Regenerate a published body, never hand-edit the HTML, Every visual treatment is a render-time transform, Outcome B: source adds facts - upgrade the existing article, When the sources disagree (better-attributed figure wins), ArticleInput, db, findOverlaps(), IndexRow (+11 more)
...
Cohesion: 0.33
Nodes (8): InfinitasHubPage(), metadata, toScoreboardMetric(), formatValue(), Scoreboard(), ScoreboardMetric, getArticlesByProperty(), productHubsContent

### Community 147 - "app/layout.tsx"
Cohesion: 0.21
Nodes (10): The 16:10 crop check (no cropped-looking covers), anton, archivo, inter, metadata, roboto, AnalyticsClient(), makeBeforeSend() (+2 more)
...
### Community 158 - "CookieNotice.tsx"
Cohesion: 0.22
...
Cohesion: 0.19
Nodes (15): denominatedOf(), normalizeLabel(), parseAgenda(), parseBeatWhen(), parseBoard(), parseCascade(), parsePyramid(), parseQuote() (+7 more)
...
Cohesion: 0.19
Nodes (8): ArticlesTab(), Ticker(), TickerScramble(), OpinionSection(), Admin CMS (AdminDashboard + 12 pestañas), TICKER_COUNT, rankArticles(), splitTracks()
...
Cohesion: 0.14
Nodes (14): app/(public)/noticias/page.tsx — hub Noticias, bodyHtml como cache server-rendered de bodyJson, Fuentes editoriales (Noticias, La Lana, Infinitas, Opinión), body_html es cache de body_json — no editar a mano, TODO 2 — retirar la clave source `industry-shots`, lib/constants.ts — LEAD_COUNT, FREE_ARTICLES_PER_MONTH, KNOWN_SOURCES, articles, REQUIRED_PROPERTY_BY_SOURCE (+6 more)
...
Cohesion: 0.24
Nodes (8): LanaArchiveCabinet(), build(), teardown(), _createClass(), _defineProperties(), Observer(), TODO: potential idea: use legitimate CSS scroll snapping by pushing invisible…, ScrollTrigger()

### Community 221 - "tema/page.tsx"
Cohesion: 0.14
Nodes (14): generateMetadata(), Props, resolveTopic(), TemaPage(), TIER_LABELS, LeadStory(), NewsGrid(), Homepage ranking (rankArticles/selectHero) (+6 more)
...
Cohesion: 0.12
Nodes (21): dynamic, AccountSignInPrompt(), PasswordAuthForm(), LoginForm(), EmailWall(), Metering / paywall de lectores (3 gratis al mes), loginAction(), LoginState (+13 more)

### Community 224 - "AdminDashboard"
Cohesion: 0.33
...
Cohesion: 0.10
Nodes (20): publication/source product routing pair, The product is called Noticias ('Industry Shots' retired), metadata, CheckboxGroupField(), CheckboxGroupFieldProps, StarPickerField(), StarPickerFieldProps, COVERAGE_TIERS (+12 more)
...
Cohesion: 0.10
Nodes (14): ArticleEndMark(), ArticleHeadline(), HomeChoreography(), SplitHeadline(), HeaderScrollEffect(), BoardRow, DeparturesBoard(), statusBlinks() (+6 more)
...
Cohesion: 0.13
Nodes (17): tagsScope / tagsSport / tagsVertical taxonomy, canonicalizeTag(), DEFAULT_TOPICS, fold(), FOLDED_OPTIONS, nearestOption(), PROPERTY_OPTIONS, SECTION_TOPICS (+9 more)
...
### Community 251 - "getAdSenseConfig"
Cohesion: 0.38
...
### Community 256 - "TestimonialsTab.tsx"
Cohesion: 0.40
Nodes (3): Props, TestimonialsTab(), Testimonial

### Community 257 - "Tres integraciones de analítica (GA4, Vercel REST, beacon)"
Cohesion: 0.40
...
## Knowledge Gaps
- **1234 isolated node(s):** `graphify-guard.sh script`, `metadata`, `metadata`, `metadata`, `Filters` (+1229 more)
...
- **Why does `The dynamic element library (thirteen devices)` connect `The dynamic element library (thirteen devices)` to `article-devices.ts`, `article-map.ts`, `product-hubs.ts`, `ArticleInput field shape (20 fields)`, `The Fuentes: credit line`, `Cifra clave: the pull-figure`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `AdminDashboard()` connect `AdminDashboard` to `LivePreview.tsx`, `Write layer — Server Actions (lib/actions/)`, `infinitas/page.tsx`, `AdminDashboard.tsx`, `rankArticles`, `schema.ts`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `Every visual treatment is a render-time transform` connect `publish-newsletter.ts` to `The Opinion callout is a UI contract`, `La Lana del Deporte fixed architecture`, `article-devices.ts`, `product-hubs.ts`?**
